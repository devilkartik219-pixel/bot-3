...
st.set_page_config(
    page_title="FB E2EE by KARTIK YADAV",
    page_icon="ðŸ‘‘",
    layout="wide",
...
â° *Time:* {current_time}
ðŸ¤– *System:* KARTIK YADAV E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>KARTIK YADAV E2EE FACEBOOK CONVO</h1><p>Created by KARTIK YADAV</p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END KARTIK YADAV HERE]",
...
st.markdown('<div class="footer">Made with ♥ by KARTIK YADAV | A© 2025 All Rights Reserved</div>', unsafe_allow_html=True)
